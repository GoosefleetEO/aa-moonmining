...
`moonmining.extractions_access` | User can access extractions and view owned moons. Can view extractions from own corporation only unless additional permissions are given.
...
`moonmining.view_alliance_extractions` | Can view extractions from all refineries belonging to their own alliance.
`moonmining.view_all_extractions` | Can view all extractions from any alliance and corporation.
